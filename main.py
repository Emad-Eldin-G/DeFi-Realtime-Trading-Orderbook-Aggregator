...
def configure_page():
    st.set_page_config(page_title="DeFi Orderbook Aggregator", page_icon="🌐💰", layout="wide", initial_sidebar_state="auto")
...
def exchange_choice_form():
    ...
    st.multiselect("Exchange", ["Binance", "Deribit"], default=["Binance", "Deribit"], key="exchange_choices")
    st.write("#")
...
def currency_choice_form():
    ...
    st.session_state["redis_key"] = f"{st.session_state['currency_1']}{st.session_state['currency_2']}"
